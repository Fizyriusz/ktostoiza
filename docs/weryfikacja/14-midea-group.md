...
[Wikipedia](https://pl.wikipedia.org/w/index.php?search=Comfee) · [Ceneo](https://www.ceneo.pl/Sprzet_AGD;szukaj-comfee) · [Szukaj](https://duckduckgo.com/?q=Comfee+AGD+producent)

| pole | wartość w bazie |
| --- | --- |
| kraj pochodzenia | Chiny |
| właściciel / grupa | Midea Group `h-midea` — podstawa: _Właściciel_ |
| segment | Budżetowy |
| zasięg | regionalny |
| dostępna w PL | tak |
| rok założenia | 2009 |
...
**Opis:** Marka należąca do giganta Midea, stworzona w celu dostarczania młodym użytkownikom funkcjonalnego, estetycznego i niedrogiego sprzętu AGD. Comfee kładzie nacisk na kompaktowe rozwiązania idealne do mniejszych mieszkań.
...
[Wikipedia](https://pl.wikipedia.org/w/index.php?search=Midea) · [Ceneo](https://www.ceneo.pl/Sprzet_AGD;szukaj-midea) · [Szukaj](https://duckduckgo.com/?q=Midea+AGD+producent)

| pole | wartość w bazie |
| --- | --- |
| kraj pochodzenia | Chiny |
| właściciel / grupa | Midea Group `h-midea` — podstawa: _Marka_ |
| segment | Standard |
| zasięg | globalny |
| dostępna w PL | tak |
| rok założenia | 1968 |
...
**Brakuje:** producent (OEM) · logo (plik `/brandsicons/midea.jpg` nie istnieje)
...
[Wikipedia](https://pl.wikipedia.org/w/index.php?search=Teka) · [Ceneo](https://www.ceneo.pl/Sprzet_AGD;szukaj-teka) · [Szukaj](https://duckduckgo.com/?q=Teka+AGD+producent)

| pole | wartość w bazie |
| --- | --- |
| kraj pochodzenia | Niemcy / Hiszpania |
| właściciel / grupa | Midea Group `h-midea` |
| segment | Premium |
| zasięg | globalny |
| dostępna w PL | tak |
| rok założenia | 1924 |
...
**Opis:** Specjalista od sprzętu do zabudowy o niemieckich korzeniach, obecnie w rękach chińskich.
...
- [ ] **sprawdzone** — `b-toshiba`

[Wikipedia](https://pl.wikipedia.org/w/index.php?search=Toshiba) · [Ceneo](https://www.ceneo.pl/Sprzet_AGD;szukaj-toshiba) · [Szukaj](https://duckduckgo.com/?q=Toshiba+AGD+producent)

| pole | wartość w bazie |
| --- | --- |
| kraj pochodzenia | Japonia / Chiny / Turcja |
| właściciel / grupa | Midea Group `h-midea` |
| segment | Standard |
| zasięg | globalny |
| dostępna w PL | tak |
